        ...
        <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
          ...
          >
            ...
            <input
              ...
              className={`search-input w-full pl-10 pr-4 py-2 rounded-lg outline-none ${
                isDarkMode ? 'placeholder-gray-500' : 'placeholder-gray-400'
              }`}
            />
          </div>
          
          {/* Filter Button with motion effect */}
          <button 
          ...
          >
            ...
            <span style={{ 
              color: isButtonHovered 
                ? '#574199'  // Purple when hovered
                : (isDarkMode ? '#60a5fa' : '#3b82f6'),  // Blue normally
              fontWeight: '600', 
              whiteSpace: 'nowrap',
