  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {tickets.map((ticket) => {
          const color = {
            A: "from-green-200 to-green-300 text-green-800",
            AB: "from-blue-200 to-blue-300 text-blue-800",
            ABC: "from-purple-200 to-purple-300 text-purple-800",
